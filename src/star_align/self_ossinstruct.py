...
def build_kwargs(instruct_mode: InstructMode, example: dict) -> dict[str, str]:
    ...
    if instruct_mode == "I->R":
        ...
        language = LANGUAGE_MAP.get(lang, "Rust")
    ...
    for chunk_index, examples in enumerate(pbar):
        ...
        for index, example in enumerate(examples):
            ...
            prompt = fewshot.random_prompt(
                args.instruct_mode,
                args.num_fewshots,
                prompting_mode=args.prompting_mode,                **kwargs,
            )
        ...
        if args.use_vllm_server:
            ...
            if args.async_micro_batch_size == 1:
                ...
                try: 
                    ...
                    print(f"Length of request_params_batched: {len(request_params_batched)}")
                    print(f"Expected n_async_chunks: {n_async_chunks}")
